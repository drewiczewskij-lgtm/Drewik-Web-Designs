...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    kicker: 'Live',
    summary: 'Photo and video coverage of events, as they happen.',
    body: 'Openings, launches, conferences, parties and celebrations, covered by one person carrying both a stills body and a gimbal so you get photographs and a film out of the same evening. Shot on available light wherever the room allows it, because a flash in every face changes the event you asked me to document.',
    includes: [
      'Stills and video from the same booking',
      'Arrivals, speeches and the key moments',
      'Room, detail and atmosphere coverage',
      'A short highlights film for social',
      'A first selection of images the next morning',
      'Full edited gallery within a few days',
    ],
    image: 'commEvent',
    packageId: 'commercial',
    portfolio: 'commercial',
  ...
  },
  {
    ...
    body: 'Developments, construction progress sets, short-term rental listings, headshots for an agency roster, a campaign that does not fit a package. If it is photography or film and it is within driving distance, describe it and you will get an honest answer about whether it is a good fit.',
    includes: [
      ...
      'Campaign and multi-day coverage',
    ],
    image: 'gearStill',
    packageId: 'commercial',
    portfolio: 'lifestyle',
